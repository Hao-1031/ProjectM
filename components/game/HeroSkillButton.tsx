...
export default function HeroSkillButton({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "pointer-events-auto relative flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl border-2 bg-panel/90 shadow-lg backdrop-blur-md touch-manipulation sm:h-[72px] sm:w-[72px]",
        ready && !disabled
