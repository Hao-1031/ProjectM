...
export default function Hero() {
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 pb-16 pt-8 md:pb-24 md:pt-12">
      <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-6">
        ...
        >
          ...
          <h1 className="mt-6 text-[clamp(2.75rem,7.5vw,5.5rem)] font-bold leading-[0.95] tracking-tight">
            每一次防守
            <br />
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
            <Link
              ...
              className="group relative inline-flex h-14 items-center justify-center gap-2.5 overflow-hidden rounded-2xl bg-primary px-8 text-base font-bold text-background shadow-lg shadow-primary/15 transition-all hover:bg-primary/90 hover:shadow-primary/25 focus-ring active:scale-[0.98]"
            >
            ...
            <Link
              href="/about"
              className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl border border-border bg-panel px-6 text-sm font-semibold text-foreground transition-all hover:border-primary/30 hover:bg-panel-raised focus-ring active:scale-[0.98]"
            >
          ...
          <div className="mt-10 flex flex-wrap items-center gap-6 text-xs text-neutral-400">
        ...
        >
          <div className="relative">
            <div className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-br from-primary/10 via-transparent to-accent/10 blur-2xl" />
            <div className="relative aspect-[16/10] overflow-hidden rounded-3xl border border-border bg-panel shadow-2xl shadow-black/30">
              ...
              <div className="absolute bottom-5 left-5 right-5 rounded-2xl border border-border/60 bg-background/80 p-4 backdrop-blur-md">
