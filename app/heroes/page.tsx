                  ...
                  return (
                    <motion.section key={hero.id}
                      ...
                      <div className="relative p-2.5 md:p-3">
                        {isLarge && (
                          <div className="relative mb-3 h-40 overflow-hidden rounded-2xl md:h-52">
                            <Image src={HERO_IMAGES[hero.id]} alt={hero.name} fill className="object-cover" sizes="(max-width: 768px) 100vw, 58vw" unoptimized />
