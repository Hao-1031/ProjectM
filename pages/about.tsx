  ...
  return (
    <Layout title="关于">
      <div className="relative overflow-hidden">
        ...
        <section className="relative mx-auto max-w-7xl px-4 py-3 md:py-4">
        ...
        <section className="relative mx-auto max-w-7xl px-4 py-3 md:py-4">
          <h2 className="text-lg font-bold tracking-tight md:text-xl">我们相信什么</h2>
                ...
                {techStack.map((tech, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="mt-1.5 text-xs font-semibold">{tech.name}</p>
